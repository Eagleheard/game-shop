...
import { getStore, getDiscount, addGameToStore, incrementGameToStore, clearStore } from 'store/cart/sagas';
import { getCartSuccess, getDiscountSuccess, addGameSuccess, changeQuantitySuccess, clearCartSuccess } from '../actions';
